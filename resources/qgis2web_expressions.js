...
function exp_Counties_3rule0_eval_expression(context) {
    // STATEFP = '39' AND NAME = 'Franklin'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('STATEFP')  == '39') && (feature.get('NAME')  == 'Franklin'));
    } else {
        return ((feature.get('STATEFP')  == '39') && (feature.get('NAME')  == 'Franklin'));
    }
}
...
function exp_Counties_3rule1_eval_expression(context) {
    // STATEFP = '39' AND NAME = 'Madison'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('STATEFP')  == '39') && (feature.get('NAME')  == 'Madison'));
    } else {
        return ((feature.get('STATEFP')  == '39') && (feature.get('NAME')  == 'Madison'));
    }
}
...
function exp_Counties_3rule2_eval_expression(context) {
    // STATEFP = '39' AND NAME <> 'Franklin' AND NAME <> 'Madison'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('STATEFP')  == '39') && (feature.get('NAME')  != 'Franklin')) && (feature.get('NAME')  != 'Madison'));
    } else {
        return (((feature.get('STATEFP')  == '39') && (feature.get('NAME')  != 'Franklin')) && (feature.get('NAME')  != 'Madison'));
    }
}